...
<?php if ($this->player->pozycja != 1) : ?>
    <?php if ($this->regular_stat) : ?>
        <table class="tabplayer">
            <tr><th colspan="6"><?php echo JText::_('HOC_PLAYER_RS') ?></th></tr>
            <tr>
        ...
        <div class="leg_p"><?php echo JText::_('HOC_STATS_INFO_P') ?></div>
    <?php endif; ?>
<?php endif ?>
...
<?php if ($this->player->pozycja == 1) : ?>
    <?php if ($this->regular_stat) : ?>
        <table class="tabplayer">
            <tr><th colspan="10"><?php echo JText::_('HOC_PLAYER_RS') ?></th></tr>
        ...
        <div class="leg_p"><?php echo JText::_('HOC_STATS_INFO_G') ?></div>
    <?php endif; ?>
<?php endif ?>
