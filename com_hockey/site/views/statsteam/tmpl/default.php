...
$link1 = JRoute::_('index.php?option=com_hockey&view=statsteam&id=1&format=raw', false);
$link2 = JRoute::_('index.php?option=com_hockey&view=statsteam&id=2&format=raw', false);
$link3 = JRoute::_('index.php?option=com_hockey&view=statsteam&id=3&format=raw', false);
$link4 = JRoute::_('index.php?option=com_hockey&view=statsteam&id=4&format=raw', false);
?>
