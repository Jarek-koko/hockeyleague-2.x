...
<tbody>
    ...
    foreach ($this->items as $row) {
        ...
        $link = JRoute::_('index.php?option=' . $this->option . '&view=report1&type=2&id_match=' . $row->id);
        $link1 = JRoute::_('index.php?option=' . $this->option . '&view=report2&type=2&id_match=' . $row->id);
        $link2 = JRoute::_('index.php?option=' . $this->option . '&view=report3&type=2&id_match=' . $row->id);
        $link3 = JRoute::_('index.php?option=' . $this->option . '&view=report4&type=2&id_match=' . $row->id);
        $link4 = JRoute::_('index.php?option=' . $this->option . '&view=report5&type=2&id_match=' . $row->id);
        $link5 = JRoute::_('index.php?option=' . $this->option . '&view=report6&type=2&id_match=' . $row->id);
        $link6 = JRoute::_('index.php?option=' . $this->option . '&view=report7&type=2&id_match=' . $row->id);
    ?>
